...
export class AddEventDashboardFields1751496311915
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "event" ADD "country" VARCHAR(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "event" ADD "state" VARCHAR(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "event" ADD "street" VARCHAR(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "event" ADD "localGovernment" VARCHAR(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "event" ADD "ticketQuantity" integer NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "event" DROP COLUMN "localGovernment"`,
    );
