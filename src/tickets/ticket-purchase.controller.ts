...
export class TicketPurchaseController {
  ...
  @ApiOperation({
    ...
    description:
      "Process a ticket purchase with payment details. Validates ticket availability, processes payment, and creates purchase record.",
  })
  @ApiBody({
    schema: {
      type: "object",
  ...
  @ApiResponse({
    ...
    description: "Invalid purchase request or insufficient tickets",
  })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve the detailed receipt for a ticket purchase including event, ticket, and billing details",
  })
  @ApiParam({
    name: "orderId",
