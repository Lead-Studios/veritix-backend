...
export class AddCurrentRefreshTokenHashToUsers1776904642002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const hasColumn = await queryRunner.hasColumn("users", "currentRefreshTokenHash");
        if (!hasColumn) {
            await queryRunner.query(`ALTER TABLE "users" ADD "currentRefreshTokenHash" varchar NULL`);
        }
    }
