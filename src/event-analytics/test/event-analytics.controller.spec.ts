...
describe('EventAnalyticsController', () => {
  ...
  beforeEach(async () => {
    ...
    eventAnalyticsService = module.get<EventAnalyticsService>(
      EventAnalyticsService,
    );
    analyticsTrackingService = module.get<AnalyticsTrackingService>(
  ...
  describe('getEventAnalytics', () => {
    it('should return event analytics', async () => {
      ...
      mockEventAnalyticsService.getEventAnalytics.mockResolvedValue(
        mockAnalytics,
      );
      ...
      expect(mockEventAnalyticsService.getEventAnalytics).toHaveBeenCalledWith(
        eventId,
        organizerId,
        filters,
      );
  ...
  describe('trackView', () => {
    it('should track view with parsed user agent', async () => {
      ...
      expect(mockAnalyticsTrackingService.parseUserAgent).toHaveBeenCalledWith(
        mockRequest.headers['user-agent'],
      );
      expect(
        mockAnalyticsTrackingService.getLocationFromIP,
    ...
    it('should track view without parsing when device info provided', async () => {
      ...
      expect(
        mockAnalyticsTrackingService.parseUserAgent,
  ...
  describe('trackPurchase', () => {
    it('should track purchase successfully', async () => {
      ...
      const result = await controller.trackPurchase(
        eventId,
        trackPurchaseDto,
        mockRequest,
      );
  ...
  describe('trackEngagement', () => {
    it('should track engagement successfully', async () => {
      ...
      const result = await controller.trackEngagement(
        eventId,
        trackEngagementDto,
        mockRequest,
      );
