...
describe('RefundService', () => {
  ...
  describe('createRefund', () => {
    ...
    it('should throw NotFoundException for non-existent ticket', async () => {
      ...
      await expect(service.createRefund(createRefundDto)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('should throw BadRequestException for refund amount exceeding ticket price', async () => {
      ...
      await expect(service.createRefund(invalidRefundDto)).rejects.toThrow(
        BadRequestException,
      );
    });
  ...
  describe('getRefundsByEvent', () => {
    ...
    it('should throw ForbiddenException for unauthorized organizer', async () => {
      ...
      await expect(
        service.getRefundsByEvent('event-1', 'wrong-organizer'),
  ...
  describe('cancelRefund', () => {
    ...
    it('should throw ForbiddenException for unauthorized user', async () => {
      ...
      await expect(
        service.cancelRefund('refund-1', 'unauthorized-user'),
      ).rejects.toThrow(ForbiddenException);
    });
    ...
    it('should throw BadRequestException for non-pending refund', async () => {
      ...
      await expect(service.cancelRefund('refund-1', 'user-1')).rejects.toThrow(
        BadRequestException,
      );
    });
  });
