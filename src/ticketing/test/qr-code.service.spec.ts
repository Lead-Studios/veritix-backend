...
describe("QrCodeService", () => {
  ...
  describe("generateQrCode", () => {
    it("should generate QR code with valid data", async () => {
      ...
      const result = await service.generateQrCode(ticketId, eventId, purchaserId)
    ...
    it("should generate different QR codes for different inputs", async () => {
      const result1 = await service.generateQrCode("ticket-1", "event-1", "user-1")
      const result2 = await service.generateQrCode("ticket-2", "event-2", "user-2")
  ...
  describe("verifyQrCode", () => {
    it("should verify valid QR code", async () => {
      ...
      const generated = await service.generateQrCode(ticketId, eventId, purchaserId)
    ...
    it("should reject QR code with tampered hash", async () => {
      const generated = await service.generateQrCode("ticket-123", "event-456", "user-789")
