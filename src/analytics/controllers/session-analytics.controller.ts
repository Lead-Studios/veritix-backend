...
import { SessionAnalyticsDashboardDto, SessionAnalyticsSummaryDto } from "../dto/session-analytics.dto"
...
export class SessionAnalyticsController {
  ...
  @ApiOperation({
    ...
    description: "Retrieve comprehensive session analytics dashboard with attendance, engagement, and performance metrics",
  })
  @ApiParam({
    name: "organizerId",
  ...
  async getSessionAnalyticsDashboard(
    ...
    const data = await this.sessionAnalyticsService.getSessionAnalyticsDashboard(organizerId, filters)
  ...
  @ApiOperation({
    ...
    description: "Retrieve summary statistics for session analytics including key performance indicators",
  })
  @ApiParam({
    name: "organizerId",
    description: "Organizer ID",
  ...
  async getSessionAnalyticsSummary(
    ...
    return this.sessionAnalyticsService.getSessionAnalyticsSummary(organizerId, filters)
  }
  ...
  @ApiOperation({
    ...
    description: "Retrieve list of available tracks for filtering session analytics",
  })
  @ApiParam({
    name: "conferenceId",
  ...
  async getAvailableTracks(@Param("conferenceId") conferenceId: string): Promise<string[]> {
  ...
  @ApiOperation({
    ...
    description: "Retrieve list of available speakers for filtering session analytics",
  })
  @ApiParam({
    name: "conferenceId",
    description: "Conference ID",
  ...
  async getAvailableSpeakers(@Param("conferenceId") conferenceId: string): Promise<string[]> {
    // This would typically come from the session repository
    // For now, returning a placeholder implementation
    return ["John Doe", "Jane Smith", "Bob Johnson", "Alice Brown", "Charlie Wilson"]
  }
} 