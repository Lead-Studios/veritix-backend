...
describe('SessionAnalyticsService', () => {
  ...
  describe('getSessionAnalyticsDashboard', () => {
    ...
    it('should return session analytics dashboard data', async () => {
      ...
      const result = await service.getSessionAnalyticsDashboard(
        'organizer-123',
        mockFilters,
      );
    ...
    it('should apply filters correctly', async () => {
      ...
      await service.getSessionAnalyticsDashboard(
        'organizer-123',
        filtersWithAllOptions,
      );
  ...
  describe('getSessionAnalyticsSummary', () => {
    ...
    it('should return session analytics summary', async () => {
      ...
      const result = await service.getSessionAnalyticsSummary(
        'organizer-123',
        mockFilters,
      );
