...
describe('AnalyticsService', () => {
  ...
  beforeEach(async () => {
    ...
    conferenceRepository = module.get<Repository<Conference>>(
  ...
  describe('getDashboardData', () => {
    it('should return dashboard data with all analytics', async () => {
      ...
      mockAttendanceRepository.createQueryBuilder.mockReturnValue(
        mockQueryBuilder,
      );
      mockFeedbackRepository.createQueryBuilder.mockReturnValue(
        mockQueryBuilder,
      );
      mockConferenceRepository.createQueryBuilder.mockReturnValue(
        mockQueryBuilder,
      );
