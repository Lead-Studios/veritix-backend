...
export class EventRevenueAnalyticsController {
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve revenue analytics for a specific event with optional time filtering'
  })
  @ApiParam({ 
    name: 'eventId', 
  ...
  @ApiResponse({ 
    ...
    schema: {
      properties: {
        ...
        averageTicketPrice: { type: 'number', example: 100.00 },
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve profit analytics for a specific event with optional time filtering'
  })
  @ApiParam({ 
    name: 'eventId', 
    description: 'ID of the event to analyze',
  ...
  @ApiResponse({ 
    ...
    schema: {
      properties: {
        totalRevenue: { type: 'number', example: 15000.50 },
        totalCosts: { type: 'number', example: 5000.00 },
        netProfit: { type: 'number', example: 10000.50 },
        ...
        profitByDay: {
          ...
          items: {
            ...
            properties: {
              date: { type: 'string', example: '2025-04-15' },
              profit: { type: 'number', example: 800.00 }
            }
          }
        }
      }
