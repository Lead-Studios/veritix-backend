...
export class EventController {
  ...
  @ApiOperation({
    summary: 'Filter events by both name and location with pagination',
  })
  @ApiResponse({
    status: 200,
    description: 'Events filtered by name and location',
  })
  @ApiResponse({ status: 400, description: 'Invalid query parameters' })
  @ApiQuery({ name: 'name', required: true, type: String })
  @ApiQuery({ name: 'location', required: true, type: String })
  ...
  @ApiOperation({
    summary:
      'Search events by name, category, and location with fuzzy matching',
  })
  @ApiQuery({
    name: 'query',
    required: false,
  ...
  @ApiQuery({
    name: 'location',
    required: false,
    description: 'Location in format Country,State,City',
  })
  @ApiQuery({
    name: 'page',
    required: false,
